                       ...
                       <!-- 
                        <div class="form-group row">
                            ...
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox"  v-model="brs_q">
                                BRS Questionnaire
                            </label>
                            </div>  
                            <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox"  v-model="urica_q">
                                URICA Questionnaire
                            </label>
                            </div>  
                            <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox"  v-model="datc_q">
                            ...
                            <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox"  v-model="spsi_q">
                            SPSI-R:S Questionnaire
                            </label>
                            </div> 
                            <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox"  v-model="mh_q">
                            Mental Helth Questionnaire
                            </label>
                            </div> 
                            <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox"  v-model="pf_q">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group sw">
                                            ...
                                            <!-- <label class="switch switch-lg switch-icon switch-primary ">
                                                <input type="checkbox" v-model="is_completed" class="switch-input " checked>
                                                <span class="switch-slider" data-on="Yes" data-off="No"></span>    
                                            </label>  -->
...
//   axios.put('/mbrp_questionnaire/delete', {params: {'id': this.id}}).then(function (response) {
            ...
            ocultarDetalle(){
                ...
                this.listMbrp_questionnaires(1,'','client_id');
            },
            comprobarMBRP(){
                this.mbrp_ok='';
